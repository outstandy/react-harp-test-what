<!DOCTYPE html><html><title>Hometown</title><link rel="stylesheet" href="/scss/main.css"><script src="https://fb.me/react-0.14.7.js"></script><script src="https://fb.me/react-dom-0.14.7.js"></script><script src="https://npmcdn.com/babel-core@5.8.38/browser.min.js"></script><script src="https://npmcdn.com/jquery@3.1.0/dist/jquery.min.js"></script><script src="https://npmcdn.com/remarkable@1.6.2/dist/remarkable.min.js"></script><body><nav><div class="grid"><div class="row"><div class="grid-1-1"><a href="#" class="titling type-300 pink">Hometown</a></div></div></div></nav><h1>Overview <a href="https://travis-ci.org/lydell/js-tokens"><img src="https://travis-ci.org/lydell/js-tokens.png?branch=master" alt="Build Status"></a></h1><p>A regex that tokenizes JavaScript.</p>
<pre><code class="language-js">var jsTokens = require(&quot;js-tokens&quot;)
...
<h3><code>var token = jsTokens.matchToToken(match)</code></h3><p>Takes a <code>match</code> returned by <code>jsTokens.exec(string)</code>, and returns a <code>{type:
...
<p>For example usage, please see this <a href="https://gist.github.com/lydell/be49dbf80c382c473004">gist</a>.</p>
<h1>ECMAScript support</h1><p>The intention is to always support the latest stable ECMAScript version.</p>
<p>If adding support for a newer version requires changes, a new version with a
major verion bump will be released.</p>
<p>Currently, <a href="http://www.ecma-international.org/ecma-262/7.0/index.html">ECMAScript 2016</a> is supported.</p>
...
<h1>Limitations</h1><p>Tokenizing JavaScript using regexes—in fact, <em>one single regex</em>—won’t be
...
code).</p>
<h1>License</h1><p><a href="LICENSE">The X11 (“MIT”) License</a>.</p><footer><div class="grid"><div class="row"><div class="grid-1-1"><p class="text off-white">This the footer</p></div></div></div></footer><script src="bundle.js"></script></body></html>