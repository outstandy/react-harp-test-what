<!DOCTYPE html><html><title>Hometown</title><link rel="stylesheet" href="/scss/main.css"><script src="https://fb.me/react-0.14.7.js"></script><script src="https://fb.me/react-dom-0.14.7.js"></script><script src="https://npmcdn.com/babel-core@5.8.38/browser.min.js"></script><script src="https://npmcdn.com/jquery@3.1.0/dist/jquery.min.js"></script><script src="https://npmcdn.com/remarkable@1.6.2/dist/remarkable.min.js"></script><body><nav><div class="grid"><div class="row"><div class="grid-1-1"><a href="#" class="titling type-300 pink">Hometown</a></div></div></div></nav><h1>bl <em>(BufferList)</em></h1><p><a href="https://travis-ci.org/rvagg/bl"><img src="https://travis-ci.org/rvagg/bl.svg?branch=master" alt="Build Status"></a></p>
...
<hr>
<p><a name="append"></a></p>
<h3>bl.append(Buffer | Buffer array | BufferList | BufferList array | String)</h3><p><code>append(buffer)</code> adds an additional buffer or BufferList to the internal list. <code>this</code> is returned so it can be chained.</p>
<hr>
<p><a name="get"></a></p>
