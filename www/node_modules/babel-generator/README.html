<!DOCTYPE html><html><title>Hometown</title><link rel="stylesheet" href="/scss/main.css"><script src="https://fb.me/react-0.14.7.js"></script><script src="https://fb.me/react-dom-0.14.7.js"></script><script src="https://npmcdn.com/babel-core@5.8.38/browser.min.js"></script><script src="https://npmcdn.com/jquery@3.1.0/dist/jquery.min.js"></script><script src="https://npmcdn.com/remarkable@1.6.2/dist/remarkable.min.js"></script><body><nav><div class="grid"><div class="row"><div class="grid-1-1"><a href="#" class="titling type-300 pink">Hometown</a></div></div></div></nav><h1>babel-generator</h1><blockquote>
<p>Turns an AST into code.</p>
</blockquote>
<h2>Install</h2><pre><code class="language-sh">$ npm install babel-generator
</code></pre>
<h2>Usage</h2><pre><code class="language-js">import {parse} from &#39;babylon&#39;;
...
<h2>Options</h2><p>Options for formatting output:</p>
<table>
<thead>
<tr>
<th>name</th>
...
<h2>AST from Multiple Sources</h2><p>In most cases, Babel does a 1:1 transformation of input-file to output-file.  However,
you may be dealing with AST constructed from multiple sources - JS files, templates, etc.
If this is the case, and you want the sourcemaps to reflect the correct sources, you&#39;ll need
to make some changes to your code.</p>
<p>First, each node with a <code>loc</code> property (which indicates that node&#39;s original placement in the
source document) must also include a <code>loc.filename</code> property, set to the source filename.</p>
<p>Second, you should pass an object to <code>generate</code> as the <code>code</code> parameter.  Keys
...
<pre><code class="language-js">import {parse} from &#39;babylon&#39;;
import generate from &#39;babel-generator&#39;;
