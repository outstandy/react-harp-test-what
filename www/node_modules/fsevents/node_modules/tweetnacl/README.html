...
<p><a href="https://dchest.github.io/tweetnacl-js/">Demo</a></p>
...
encode or decode strings, use functions from <code>nacl.util</code> namespace.</p>
...
<p>Note that browsers are required to throw <code>QuotaExceededError</code> exception if
requested <code>length</code> is more than 65536, so do not ask for more than 65536 bytes
in <em>one call</em> (multiple calls to get as many bytes as you like are okay:
...
<h3>Utilities</h3><p>Encoding/decoding functions are provided for convenience. They are correct,
...
implementation. You can use third-party libraries if you need to.</p>
<h4>nacl.util.decodeUTF8(string)</h4><p>Decodes string and returns <code>Uint8Array</code> of bytes.</p>
<h4>nacl.util.encodeUTF8(array)</h4><p>Encodes <code>Uint8Array</code> or <code>Array</code> of bytes into string.</p>
<h4>nacl.util.decodeBase64(string)</h4><p>Decodes Base-64 encoded string and returns <code>Uint8Array</code> of bytes.</p>
<h4>nacl.util.encodeBase64(array)</h4><p>Encodes <code>Uint8Array</code> or <code>Array</code> of bytes into string using Base-64 encoding.</p>
...
<p>Other systems:</p>
<ul>
<li>Node.js (we test on 0.10 and later)</li>
</ul>
...
<pre><code>$ NACL_SRC=nacl-fast.min.js npm test
