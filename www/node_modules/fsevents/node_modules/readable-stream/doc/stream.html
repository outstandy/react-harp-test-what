<!DOCTYPE html><html><title>Hometown</title><link rel="stylesheet" href="/scss/main.css"><script src="https://fb.me/react-0.14.7.js"></script><script src="https://fb.me/react-dom-0.14.7.js"></script><script src="https://npmcdn.com/babel-core@5.8.38/browser.min.js"></script><script src="https://npmcdn.com/jquery@3.1.0/dist/jquery.min.js"></script><script src="https://npmcdn.com/remarkable@1.6.2/dist/remarkable.min.js"></script><body><nav><div class="grid"><div class="row"><div class="grid-1-1"><a href="#" class="titling type-300 pink">Hometown</a></div></div></div></nav><h1>Stream</h1><pre><code>Stability: 2 - Stable
</code></pre><p>A stream is an abstract interface implemented by various objects in
Node.js. For example a <a href="https://nodejs.org/docs/v6.1.0/api/http.html#http_class_http_incomingmessage">request to an HTTP server</a> is a
stream, as is <a href="https://nodejs.org/docs/v6.1.0/api/process.html#process_process_stdout"><code>process.stdout</code></a>. Streams are readable, writable, or both. All
streams are instances of <a href="https://nodejs.org/docs/v6.1.0/api/events.html#events_class_eventemitter"><code>EventEmitter</code></a>.</p>
...
<h3>Class: stream.Duplex</h3><p>Duplex streams are streams that implement both the <a href="#stream_class_stream_readable">Readable</a> and
<a href="#stream_class_stream_writable">Writable</a> interfaces.</p>
<p>Examples of Duplex streams include:</p>
<ul>
<li><a href="https://nodejs.org/docs/v6.1.0/api/net.html#net_class_net_socket">TCP sockets</a></li>
<li><a href="zlib.html">zlib streams</a></li>
<li><a href="crypto.html">crypto streams</a></li>
</ul>
<h3>Class: stream.Readable</h3><!--type=class-->
...
<ul>
<li><a href="https://nodejs.org/docs/v6.1.0/api/http.html#http_class_http_incomingmessage">HTTP responses, on the client</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/http.html#http_class_http_incomingmessage">HTTP requests, on the server</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/fs.html#fs_class_fs_readstream">fs read streams</a></li>
<li><a href="zlib.html">zlib streams</a></li>
<li><a href="crypto.html">crypto streams</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/net.html#net_class_net_socket">TCP sockets</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/child_process.html#child_process_child_stdout">child process stdout and stderr</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/process.html#process_process_stdin"><code>process.stdin</code></a></li>
</ul>
<h4>Event: &#39;close&#39;</h4><p>Emitted when the stream and any of its underlying resources (a file
...
<h4>Event: &#39;end&#39;</h4><p>This event fires when there will be no more data to read.</p>
...
<h4>Event: &#39;error&#39;</h4><ul>
<li>{Error}</li>
</ul>
<p>Emitted if there was an error receiving data.</p>
<h4>Event: &#39;readable&#39;</h4><p>When a chunk of data can be read from the stream, it will emit a
...
</code></pre><h4>readable.isPaused()</h4><ul>
...
<h4>readable.pipe(destination[, options])</h4><ul>
...
<p>Note that <a href="https://nodejs.org/docs/v6.1.0/api/process.html#process_process_stderr"><code>process.stderr</code></a> and <a href="https://nodejs.org/docs/v6.1.0/api/process.html#process_process_stdout"><code>process.stdout</code></a> are never closed until
the process exits, regardless of the specified options.</p>
<h4>readable.read([size])</h4><ul>
...
<h4>readable.resume()</h4><ul>
<li>Return: <code>this</code></li>
</ul>
<p>This method will cause the readable stream to resume emitting <a href="#stream_event_data"><code>&#39;data&#39;</code></a>
events.</p>
...
<h4>readable.setEncoding(encoding)</h4><ul>
...
called <a href="https://nodejs.org/docs/v6.1.0/api/buffer.html#buffer_buf_tostring_encoding_start_end"><code>buf.toString(encoding)</code></a> on them. If you want to read the data
...
<h4>readable.unpipe([destination])</h4><ul>
<li><code>destination</code> {stream.Writable} Optional specific stream to unpipe</li>
</ul>
<p>This method will remove the hooks set up for a previous <a href="#stream_readable_pipe_destination_options"><code>stream.pipe()</code></a>
call.</p>
...
<h4>readable.unshift(chunk)</h4><ul>
...
<h3>Class: stream.Transform</h3><p>Transform streams are <a href="#stream_class_stream_duplex">Duplex</a> streams where the output is in some way
...
<h3>Class: stream.Writable</h3><!--type=class-->
...
<ul>
<li><a href="https://nodejs.org/docs/v6.1.0/api/http.html#http_class_http_clientrequest">HTTP requests, on the client</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/http.html#http_class_http_serverresponse">HTTP responses, on the server</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/fs.html#fs_class_fs_writestream">fs write streams</a></li>
<li><a href="zlib.html">zlib streams</a></li>
<li><a href="crypto.html">crypto streams</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/net.html#net_class_net_socket">TCP sockets</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/child_process.html#child_process_child_stdin">child process stdin</a></li>
<li><a href="https://nodejs.org/docs/v6.1.0/api/process.html#process_process_stdout"><code>process.stdout</code></a>, <a href="https://nodejs.org/docs/v6.1.0/api/process.html#process_process_stderr"><code>process.stderr</code></a></li>
</ul>
<h4>Event: &#39;close&#39;</h4><p>Emitted when the stream and any of its underlying resources (a file descriptor,
...
<p>Not all streams will emit the <code>&#39;close&#39;</code> event as the <code>&#39;close&#39;</code> event is
optional.</p>
<h4>Event: &#39;drain&#39;</h4><p>If a <a href="#stream_writable_write_chunk_encoding_callback"><code>stream.write(chunk)</code></a> call returns <code>false</code>, then the
...
<h4>Event: &#39;finish&#39;</h4><p>When the <a href="#stream_writable_end_chunk_encoding_callback"><code>stream.end()</code></a> method has been called, and all data has
...
<p>This is emitted whenever the <a href="#stream_readable_pipe_destination_options"><code>stream.pipe()</code></a> method is called on a readable
...
<p>This is emitted whenever the <a href="#stream_readable_unpipe_destination"><code>stream.unpipe()</code></a> method is called on a
...
<h4>writable.cork()</h4><p>Forces buffering of all writes.</p>
...
<h4>writable.end([chunk][, encoding][, callback])</h4><ul>
...
<h4>writable.setDefaultEncoding(encoding)</h4><ul>
<li><code>encoding</code> {String} The new default encoding</li>
<li>Return: <code>this</code></li>
</ul>
<p>Sets the default encoding for a writable stream.</p>
<h4>writable.uncork()</h4><p>Flush all data, buffered since <a href="#stream_writable_cork"><code>stream.cork()</code></a> call.</p>
<h4>writable.write(chunk[, encoding][, callback])</h4><ul>
...
<h2>API for Stream Implementors</h2><!--type=misc-->
...
<a href="https://nodejs.org/docs/v6.1.0/api/util.html#util_util_inherits_constructor_superconstructor"><code>util.inherits()</code></a> method is particularly helpful for this.)</li>
...
<h3>Class: stream.Duplex</h3><!--type=class-->
...
initialized.</p>
<h3>Class: stream.PassThrough</h3><p>This is a trivial implementation of a <a href="#stream_class_stream_transform">Transform</a> stream that simply
...
<h4>Example: A Counting Stream</h4><!--type=example-->
...
<h4>Example: SimpleProtocol v1 (Sub-optimal)</h4><p>This is similar to the <code>parseHeader</code> function described
...
<h3>Class: stream.Transform</h3><p>A &quot;transform&quot; stream is a duplex stream where the output is causally
...
constructor so that the buffering settings can be properly
initialized.</p>
<h4>Events: &#39;finish&#39; and &#39;end&#39;</h4><p>The <a href="#stream_event_finish"><code>&#39;finish&#39;</code></a> and <a href="#stream_event_end"><code>&#39;end&#39;</code></a> events are from the parent Writable
...
programs. However, you <strong>are</strong> expected to override this method in
your own extension classes.</p>
<h4>Example: <code>SimpleProtocol</code> parser v2</h4><p>The example <a href="#stream_example_simpleprotocol_v1_sub_optimal">here</a> of a simple
...
<h4>new stream.Writable([options])</h4><ul>
<li><code>options</code> {Object}<ul>
...
<h2>Simplified Constructor API</h2><!--type=misc-->
...
<p>Examples:</p>
<h3>Duplex</h3><pre><code class="language-js">var duplex = new stream.Duplex({
  read: function(n) {
...
<h3>Readable</h3><pre><code class="language-js">var readable = new stream.Readable({
  read: function(n) {
    // sets this._read under the hood
...
<h3>Transform</h3><pre><code class="language-js">var transform = new stream.Transform({
...
<h3>Writable</h3><pre><code class="language-js">var writable = new stream.Writable({
  write: function(chunk, encoding, next) {
    // sets this._write under the hood
...
<h2>Streams: Under the Hood</h2><!--type=misc-->
...
<h3><code>stream.read(0)</code></h3><p>There are some cases where you want to trigger a refresh of the
...
<h3><code>stream.push(&#39;&#39;)</code></h3><p>Pushing a zero-byte string or Buffer (when not in <a href="#stream_object_mode">Object mode</a>) has an
...
<a href="https://nodejs.org/docs/v6.1.0/api/tls.html#tls_class_cryptostream"><code>tls.CryptoStream</code></a> class, which is deprecated in Node.js/io.js v1.0. If you
find that you have to use <code>stream.push(&#39;&#39;)</code>, please consider another
approach, because it almost certainly indicates that something is
horribly wrong.</p><footer><div class="grid"><div class="row"><div class="grid-1-1"><p class="text off-white">This the footer</p></div></div></div></footer><script src="bundle.js"></script></body></html>