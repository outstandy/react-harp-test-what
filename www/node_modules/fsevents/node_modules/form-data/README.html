...
<h2>Install</h2><pre><code>npm install form-data
...
<h2>License</h2><p>Form-Data is licensed under the MIT license.</p><footer><div class="grid"><div class="row"><div class="grid-1-1"><p class="text off-white">This the footer</p></div></div></div></footer><script src="bundle.js"></script></body></html>