<!DOCTYPE html><html><title>Hometown</title><link rel="stylesheet" href="/scss/main.css"><script src="https://fb.me/react-0.14.7.js"></script><script src="https://fb.me/react-dom-0.14.7.js"></script><script src="https://npmcdn.com/babel-core@5.8.38/browser.min.js"></script><script src="https://npmcdn.com/jquery@3.1.0/dist/jquery.min.js"></script><script src="https://npmcdn.com/remarkable@1.6.2/dist/remarkable.min.js"></script><body><nav><div class="grid"><div class="row"><div class="grid-1-1"><a href="#" class="titling type-300 pink">Hometown</a></div></div></div></nav><h2>are-we-there-yet</h2><p>Track complex hiearchies of asynchronous task completion statuses.  This is
...
<h1>Usage</h1><pre><code class="language-javascript">var TrackerGroup = require(&quot;are-we-there-yet&quot;).TrackerGroup
...
<h1>Shared Methods</h1><p>All tracker objects described below have the following methods, they, along
with the event comprise the interface for consumers of tracker objects.</p>
<ul>
...
<h1>Events</h1><p>All tracker objects emit <code>change</code> events with the following arguments:</p>
<pre><code>function (name, completed, tracker)
</code></pre><p><code>name</code> is the name of the tracker that originally emitted the event,
...
<h1>TrackerGroup</h1><ul>
<li><p>var tracker = new TrackerGroup(<strong>name</strong>)</p>
<ul>
...
<ul>
<li><p>tracker.addUnit(<strong>otherTracker</strong>, <strong>weight</strong>)</p>
<ul>
...
<h1>Tracker</h1><ul>
<li><p>var tracker = new Tracker(<strong>name</strong>, <strong>todo</strong>)</p>
<ul>
...
<ul>
<li><p>tracker.addWork(<strong>todo</strong>)</p>
<ul>
...
<ul>
<li><p>tracker.completeWork(<strong>completed</strong>)</p>
<ul>
...
<h1>TrackerStream</h1><ul>
<li><p>var tracker = new TrackerStream(<strong>name</strong>, <strong>size</strong>, <strong>options</strong>)</p>
<ul>
<li><strong>name</strong> <em>(optional)</em> The name of this counter to report in change
events.  Defaults to undefined.</li>
...
<p>Increases the amount of work to be done, thus decreasing the completion
percentage.  Triggers a <code>change</code> event.</p><footer><div class="grid"><div class="row"><div class="grid-1-1"><p class="text off-white">This the footer</p></div></div></div></footer><script src="bundle.js"></script></body></html>