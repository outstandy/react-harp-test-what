...
<h3>Basic Usage</h3><pre><code class="language-C">#include &quot;sass/functions.h&quot;
</code></pre>
<h2>Sass Importer API</h2><pre><code class="language-C">// Forward declaration
struct Sass_Import;
