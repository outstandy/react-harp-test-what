<!DOCTYPE html><html><title>Hometown</title><link rel="stylesheet" href="/scss/main.css"><script src="https://fb.me/react-0.14.7.js"></script><script src="https://fb.me/react-dom-0.14.7.js"></script><script src="https://npmcdn.com/babel-core@5.8.38/browser.min.js"></script><script src="https://npmcdn.com/jquery@3.1.0/dist/jquery.min.js"></script><script src="https://npmcdn.com/remarkable@1.6.2/dist/remarkable.min.js"></script><body><nav><div class="grid"><div class="row"><div class="grid-1-1"><a href="#" class="titling type-300 pink">Hometown</a></div></div></div></nav><p><code>Sass_Values</code> are used to pass values and their types between the implementer and LibSass. Sass knows various different value types (including nested arrays and hash-maps). If you implement a binding to another programming language, you have to find a way to convert <code>Sass_Values</code> between the targeted language and C. <code>Sass_Values</code> are currently only used by custom functions.</p>
<h3>Basic Usage</h3><pre><code class="language-C">#include &quot;sass/values.h&quot;
</code></pre>
...
<h3>Sass Value API</h3><pre><code class="language-C">// Forward declaration
union Sass_Value;
...
<h3>More links</h3><ul>
<li><a href="api-value-example.md">Sass Value Example</a></li>
<li><a href="api-value-internal.md">Sass Value Internal</a></li>
