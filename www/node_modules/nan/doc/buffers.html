...
<h3>Nan::NewBuffer()</h3><p>Allocate a new <code>node::Buffer</code> object with the specified size and optional data. Calls <code>node::Buffer::New()</code>.</p>
...
<h3>Nan::CopyBuffer()</h3><p>Similar to <a href="#api_nan_new_buffer"><code>Nan::NewBuffer()</code></a> except that an implicit memcpy will occur within Node. Calls <code>node::Buffer::Copy()</code>.</p>
...
<h3>Nan::FreeCallback()</h3><p>A free callback that can be provided to <a href="#api_nan_new_buffer"><code>Nan::NewBuffer()</code></a>.
